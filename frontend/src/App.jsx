...
export default function App() {
  ...
  "
>
          <Header count={count} onCart={() => setCartOpen(true)} onAuth={() => setAuthOpen(true)} />
      <main>
        <Hero />
        <Story />
        <ServicesBar />
        <Products products={products} loading={productsLoading} error={productsError} onAdd={add} />
        <BlendBuilder products={products} loading={productsLoading} onAdd={add} />
      </main>
      <Footer />
      ...
      <CheckoutModal open={checkoutOpen} onClose={() => setCheckoutOpen(false)} total={total} items={items} user={user} onOrderPlaced={clear} />
